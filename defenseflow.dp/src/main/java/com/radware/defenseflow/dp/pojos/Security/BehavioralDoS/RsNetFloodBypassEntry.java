...
/**
 * This structure describes the parameters of a rsNetFloodBypassEntry
 */
public class RsNetFloodBypassEntry  implements java.io.Serializable {
    ...
    /* The bypass status */
    private com.radware.defenseflow.dp.pojos.Security.BehavioralDoS.RsNetFloodBypassEntry_BypassStatus bypassStatus;
    ...
    public RsNetFloodBypassEntry(
           ...
           com.radware.defenseflow.dp.pojos.Security.BehavioralDoS.RsNetFloodBypassEntry_BypassStatus bypassStatus,
    ...
    /**
     * Gets the bypassController value for this RsNetFloodBypassEntry.
     * 
    ...
    /**
     * Sets the bypassController value for this RsNetFloodBypassEntry.
     * 
    ...
    /**
     * Gets the bypassField value for this RsNetFloodBypassEntry.
     * 
    ...
    /**
     * Sets the bypassField value for this RsNetFloodBypassEntry.
     * 
    ...
    /**
     * Gets the bypassStatus value for this RsNetFloodBypassEntry.
     * 
     * @return bypassStatus   * The bypass status
     */
    public com.radware.defenseflow.dp.pojos.Security.BehavioralDoS.RsNetFloodBypassEntry_BypassStatus getBypassStatus() {
        return bypassStatus;
    }


    /**
     * Sets the bypassStatus value for this RsNetFloodBypassEntry.
     * 
     * @param bypassStatus   * The bypass status
     */
    public void setBypassStatus(com.radware.defenseflow.dp.pojos.Security.BehavioralDoS.RsNetFloodBypassEntry_BypassStatus bypassStatus) {
        this.bypassStatus = bypassStatus;
    }


    /**
     * Gets the bypassValues value for this RsNetFloodBypassEntry.
     * 
    ...
    /**
     * Sets the bypassValues value for this RsNetFloodBypassEntry.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RsNetFloodBypassEntry)) return false;
        RsNetFloodBypassEntry other = (RsNetFloodBypassEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RsNetFloodBypassEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("radware.Security.BehavioralDoS", "rsNetFloodBypassEntry"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("radware.Security.BehavioralDoS", "rsNetFloodBypassEntry_BypassStatus"));
