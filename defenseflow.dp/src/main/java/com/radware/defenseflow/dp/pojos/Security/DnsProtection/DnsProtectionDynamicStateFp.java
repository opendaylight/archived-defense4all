/**
 * DnsProtectionDynamicStateFp.java
 *
...
/**
 * This structure describes the parameters of a DnsProtectionDynamicStateFp
 */
public class DnsProtectionDynamicStateFp  implements java.io.Serializable {
    /* The controller */
    ...
    /* The dynamic state */
    private com.radware.defenseflow.dp.pojos.Security.DnsProtection.DnsProtectionDynamicStateFp_DetectionCondition detectionCondition;

    public DnsProtectionDynamicStateFp() {
    }
    ...
    public DnsProtectionDynamicStateFp(
           ...
           com.radware.defenseflow.dp.pojos.Security.DnsProtection.DnsProtectionDynamicStateFp_DetectionCondition detectionCondition) {
    ...
    /**
     * Gets the protectionType value for this DnsProtectionDynamicStateFp.
     * 
    ...
    /**
     * Sets the protectionType value for this DnsProtectionDynamicStateFp.
     * 
    ...
    /**
     * Gets the footprintType value for this DnsProtectionDynamicStateFp.
     * 
    ...
    /**
     * Sets the footprintType value for this DnsProtectionDynamicStateFp.
     * 
    ...
    /**
     * Gets the detectionCondition value for this DnsProtectionDynamicStateFp.
     * 
     * @return detectionCondition   * The dynamic state
     */
    public com.radware.defenseflow.dp.pojos.Security.DnsProtection.DnsProtectionDynamicStateFp_DetectionCondition getDetectionCondition() {
        return detectionCondition;
    }


    /**
     * Sets the detectionCondition value for this DnsProtectionDynamicStateFp.
     * 
     * @param detectionCondition   * The dynamic state
     */
    public void setDetectionCondition(com.radware.defenseflow.dp.pojos.Security.DnsProtection.DnsProtectionDynamicStateFp_DetectionCondition detectionCondition) {
        this.detectionCondition = detectionCondition;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DnsProtectionDynamicStateFp)) return false;
        DnsProtectionDynamicStateFp other = (DnsProtectionDynamicStateFp) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DnsProtectionDynamicStateFp.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("radware.Security.DnsProtection", "DnsProtectionDynamicStateFp"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("radware.Security.DnsProtection", "DnsProtectionDynamicStateFp_DetectionCondition"));
