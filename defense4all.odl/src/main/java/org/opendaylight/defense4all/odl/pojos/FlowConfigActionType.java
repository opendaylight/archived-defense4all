...
public class FlowConfigActionType {
	...
	public static String getOutput(String actionValue) {return "OUTPUT" + actionValue;}
	public static String getDrop(String actionValue) {return "DROP" + actionValue;}
	public static String getSendToNormal() {return "HW_PATH";}
}